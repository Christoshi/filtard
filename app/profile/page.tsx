        ...
        <div className="rounded-2xl border border-[#1c1f26] bg-[#0a0b0e] overflow-hidden">
          ...
          {(twitterUrl || telegramUrl || discordUrl) && (
            <div className="px-6 pb-5">
              <p className="text-xs text-[#5c6573] uppercase tracking-wider mb-3">Socials</p>
          ...
          {(solWallet || evmWallet) && (
            <div className="px-6 pb-6 border-t border-[#1c1f26] pt-5">
              <p className="text-xs text-[#5c6573] uppercase tracking-wider mb-3">Wallets (for tips)</p>
                ...
                {solWallet && (
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <code className="text-sm text-[#c8cdd5] truncate">{truncate(solWallet)}</code>
                    </div>
                    <button
                ...
                {evmWallet && (
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <code className="text-sm text-[#c8cdd5] truncate">{truncate(evmWallet)}</code>
                    </div>
                    <button
          ...
          {/* Empty state */}
          {!twitterUrl && !telegramUrl && !discordUrl && !solWallet && !evmWallet && (
            <div className="px-6 pb-6 text-sm text-[#5c6573]">
              No socials or wallets added yet. Click the edit icon to add them.
            </div>
          )}
        </div>
