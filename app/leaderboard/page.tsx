    ...
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-[#8b93a1] mt-1.5">
          Earn FTD points based on tokens submitted and performance
        </p>
      </div>
      ...
      {leaderboard.length === 0 ? (
        ...
        <>
          <div className="border border-[#1c1f26] rounded-2xl overflow-hidden">
            ...
            <div className="grid grid-cols-[56px_2.2fr_90px_110px_110px_100px] gap-3 px-5 py-3.5 bg-[#0c0d10] border-b border-[#1c1f26] text-xs text-[#8b93a1] tracking-wide">
              <div>Rank</div>
              <div>Curator</div>
            ...
            {leaderboard.map((curator, index) => {
              ...
              return (
                <div
                  key={curator.id}
                  className={`grid grid-cols-[56px_2.2fr_90px_110px_110px_100px] gap-3 items-center px-5 py-4 border-b border-[#1c1f26] last:border-0 hover:bg-[#14171d] transition ${
                ...
                >
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    {curator.avatar_url ? (
                      <img
                        ...
                        alt=""
                        className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-1 ring-[#1c1f26]"
                      />
                    ) : (
                  ...
                  {/* Points - centered */}
                  <div className="text-center font-semibold text-[#b8ff3d] tabular-nums">
                    {curator.points.toLocaleString()}
                  </div>

                  {/* Multiplier - centered */}
                  <div className="text-center text-[#8b93a1] tabular-nums">
          ...
          {/* Formula explanation at the bottom */}
          <div className="mt-6 px-1 text-sm text-[#8b93a1] leading-relaxed">
            <p>
              * <span className="text-[#f4f6f8]">Formula:</span> Points = Tokens × 10 × Multiplier
            </p>
            <p className="mt-1.5">
